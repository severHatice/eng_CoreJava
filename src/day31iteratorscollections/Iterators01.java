...
public class Iterators01 {
	...
	public static void main(String[] args) {
		...
		ListIterator <String> list1itr = list1.listIterator();//[   Ali,    Can,    Aliye,   ]	//burada new yok bir obje olusturmuyoruz	
		...
		while(list3Itr.hasNext()) {
			list3Itr.next();
			list3Itr.remove();//son uzerinden gecilen elemani siler
		}
